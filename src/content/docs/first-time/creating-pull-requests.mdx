...
Contributions to the docs repo are made through "pull requests" (PRs). After making changes to your own fork (copy) of the docs repository, you can request that we "pull in" your changes to update the main docs site.
