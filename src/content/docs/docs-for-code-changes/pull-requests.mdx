...
If you have never made a pull request (PR) to Astro docs, you can learn more about [contributing with a fork of the docs repo](/first-time/larger-contributions/) or [making smaller edits to a single page](/first-time/edit-single-page/) as well as our [PR review and merging process](/first-time/pr-review-process/) in our First-Time Contributors section.
